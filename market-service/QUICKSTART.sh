...
# Step 1: 编译项目
echo -e "${BLUE}Step 1: Compiling market-service...${NC}"
...
if [ $? -eq 0 ]; then
    ...
    JAR_FILE=$(find target -name "market-service-*.jar" | grep -v sources)
...
echo ""
echo "To start the market-service with WebSocket support:"
echo ""
echo "  ${YELLOW}cd /Users/ganten/workspace/github/peanuts/market-service${NC}"
echo "  ${YELLOW}java -jar target/market-service-1.0.0-SNAPSHOT.jar${NC}"
echo ""
...
echo "   ${BLUE}http://localhost:8080/websocket-client.html${NC}"
echo ""
echo "2. WebSocket Endpoint:"
echo "   ${BLUE}ws://localhost:8080/ws/market${NC}"
echo ""
echo "3. Python Test Script:"
echo "   ${YELLOW}python3 /Users/ganten/workspace/github/peanuts/market-service/test-websocket.py${NC}"
echo ""
...
echo "  ${BLUE}/Users/ganten/workspace/github/peanuts/market-service/README-WEBSOCKET.md${NC}"
echo ""
